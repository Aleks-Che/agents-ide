...
4. В **Шаблонах** скопируйте пресет «Разработка с планом» либо создайте граф.
   ...
   ПКМ по карточке открывает меню **Копировать / Редактировать / Версии / Удалить**.
   **Редактировать** открывает конструктор с черновиком или последней опубликованной версией;
   для встроенного пресета сначала создаётся редактируемая копия. Копирование пользовательского
   шаблона сохраняет его черновик и последнюю опубликованную версию. Удаление скрывает шаблон
   из списка, сохраняя версии и существующие привязки; встроенные шаблоны удалить нельзя.
