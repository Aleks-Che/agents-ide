...
Дата: 14 сентября 2026 года. Статус: этапы 0–2, конфигурация групп моделей (2A) и конфигурационная часть этапа 3 реализованы. Выполнение графов, интеграционные проверки preflight, выбор и переключение кандидатов worker, UI групп и дальнейшие продуктовые сценарии ожидают следующих этапов.
