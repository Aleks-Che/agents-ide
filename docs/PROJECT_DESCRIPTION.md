...
Дата: 14 сентября 2026 года. Статус: этапы 0–2, конфигурация групп моделей (2A), конфигурационная часть этапа 3 и движок этапа 4 в simulated-режиме реализованы и прошли ревью. Worker выполняет repair-циклы и безопасный выбор/retry/fallback кандидатов. Resume/recovery, реальные интеграционные проверки preflight, UI групп и дальнейшие продуктовые сценарии ожидают следующих этапов.
