...
Дата: 14 сентября 2026 года. Статус: этапы 0–2 и конфигурация групп моделей (2A) реализованы. Выполнение графов, выбор и переключение кандидатов worker, UI групп и дальнейшие продуктовые сценарии ожидают следующих этапов.
