...
export const waitingDescriptions: Record<string, string> = {
  session_resume_unavailable:
    'Не удалось продолжить сохранённую сессию агента. Нажмите «Предоставить решение», чтобы выбрать следующую модель группы с сохранением контекста или повторить продолжение после устранения причины.',
  limit_exceeded:
  ...
  model_group_exhausted:
    'Все кандидаты группы исчерпаны. Измените общую группу или восстановите доступ к моделям и нажмите «Продолжить».',
  workspace_conflict:
