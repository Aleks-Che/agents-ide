    ...
    >
      <div className="dialog wide binding-editor">
        ...
        <section className="binding-roles" aria-label="Роли и выбор моделей">
          ...
          {version.isLoading ? (
            ...
            <p className="panel-empty">
              Граф этой версии не объявляет ролей. Выбор моделей не требуется.
            </p>
          ) : (
        ...
        <section aria-label="Проверка готовности">
          ...
          <p className="hint">
            Проверка использует входы версии и сохранённые настройки. Текущие
...
function RoleDraftRow({
  ...
  return (
    <div className="binding-role-row">
      ...
      {selectionKind === null ? (
        <p className="hint">
          Выбор из версии или узла. Сохранённые значения показаны в таблице
