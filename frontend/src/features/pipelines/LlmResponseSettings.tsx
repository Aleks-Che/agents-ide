  ...
  return (
    <fieldset className="schema-group">
      ...
      <p className="muted">
        ...
        reasoning. Извлечение также пропускает эти блоки и принимает один целый
        JSON-объект вне размышлений. Исходный ответ сохраняется, а извлечённый
        результат проверяется по схеме узла.
      </p>
    </fieldset>
  )
}
